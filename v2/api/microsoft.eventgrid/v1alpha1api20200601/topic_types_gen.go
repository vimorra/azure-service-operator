...
func (topic *Topic) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected storage:microsoft.eventgrid/v1alpha1api20200601storage/Topic but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-microsoft-eventgrid-azure-com-v1alpha1api20200601-topic,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.eventgrid.azure.com,resources=topics,verbs=create;update,versions=v1alpha1api20200601,name=default.v1alpha1api20200601.topics.microsoft.eventgrid.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-eventgrid-azure-com-v1alpha1api20200601-topic,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.eventgrid.azure.com,resources=topics,verbs=create;update,versions=v1alpha1api20200601,name=validate.v1alpha1api20200601.topics.microsoft.eventgrid.azure.com,admissionReviewVersions=v1beta1
