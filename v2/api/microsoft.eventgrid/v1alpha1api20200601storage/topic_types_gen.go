...
// +kubebuilder:rbac:groups=microsoft.eventgrid.azure.com,resources=topics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=microsoft.eventgrid.azure.com,resources={topics/status,topics/finalizers},verbs=get;update;patch
