...
func (namespacesQueue *NamespacesQueue) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1alpha1api20210601previewstorage.NamespacesQueue
	...
	err = namespacesQueue.AssignPropertiesFromNamespacesQueue(&source)
	if err != nil {
		return errors.Wrap(err, "converting from source to namespacesQueue")
	}
...
func (namespacesQueue *NamespacesQueue) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1alpha1api20210601previewstorage.NamespacesQueue
	err := namespacesQueue.AssignPropertiesToNamespacesQueue(&destination)
	if err != nil {
		return errors.Wrap(err, "converting to destination from namespacesQueue")
	}
...
// +kubebuilder:webhook:path=/mutate-microsoft-servicebus-azure-com-v1alpha1api20210601preview-namespacesqueue,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.servicebus.azure.com,resources=namespacesqueues,verbs=create;update,versions=v1alpha1api20210601preview,name=default.v1alpha1api20210601preview.namespacesqueues.microsoft.servicebus.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-servicebus-azure-com-v1alpha1api20210601preview-namespacesqueue,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.servicebus.azure.com,resources=namespacesqueues,verbs=create;update,versions=v1alpha1api20210601preview,name=validate.v1alpha1api20210601preview.namespacesqueues.microsoft.servicebus.azure.com,admissionReviewVersions=v1beta1
...
func (namespacesQueue *NamespacesQueue) AssignPropertiesFromNamespacesQueue(source *v1alpha1api20210601previewstorage.NamespacesQueue) error {
...
func (namespacesQueue *NamespacesQueue) AssignPropertiesToNamespacesQueue(destination *v1alpha1api20210601previewstorage.NamespacesQueue) error {

	// Spec
	var spec v1alpha1api20210601previewstorage.NamespacesQueues_Spec
	...
	// Status
	var status v1alpha1api20210601previewstorage.SBQueue_Status
...
const NamespacesQueuesSpecAPIVersion20210601Preview = NamespacesQueuesSpecAPIVersion("2021-06-01-preview")
...
type NamespacesQueues_Spec struct {
	...
	//MaxMessageSizeInKilobytes: Maximum size (in KB) of the message payload that can
	//be accepted by the queue. This property is only used in Premium today and
	//default is 1024.
...
func (namespacesQueuesSpec *NamespacesQueues_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if namespacesQueuesSpec.MaxMessageSizeInKilobytes != nil {
		maxMessageSizeInKilobytes := *namespacesQueuesSpec.MaxMessageSizeInKilobytes
...
func (namespacesQueuesSpec *NamespacesQueues_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties.MaxMessageSizeInKilobytes != nil {
		...
		namespacesQueuesSpec.MaxMessageSizeInKilobytes = &maxMessageSizeInKilobytes
	}
...
func (namespacesQueuesSpec *NamespacesQueues_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1alpha1api20210601previewstorage.NamespacesQueues_Spec)
	if ok {
	...
	src = &v1alpha1api20210601previewstorage.NamespacesQueues_Spec{}
...
func (namespacesQueuesSpec *NamespacesQueues_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1alpha1api20210601previewstorage.NamespacesQueues_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1alpha1api20210601previewstorage.NamespacesQueues_Spec{}
...
func (namespacesQueuesSpec *NamespacesQueues_Spec) AssignPropertiesFromNamespacesQueuesSpec(source *v1alpha1api20210601previewstorage.NamespacesQueues_Spec) error {
	...
	namespacesQueuesSpec.MaxMessageSizeInKilobytes = genruntime.ClonePointerToInt(source.MaxMessageSizeInKilobytes)
...
func (namespacesQueuesSpec *NamespacesQueues_Spec) AssignPropertiesToNamespacesQueuesSpec(destination *v1alpha1api20210601previewstorage.NamespacesQueues_Spec) error {
	...
	// MaxMessageSizeInKilobytes
	destination.MaxMessageSizeInKilobytes = genruntime.ClonePointerToInt(namespacesQueuesSpec.MaxMessageSizeInKilobytes)
...
func (sbQueueStatus *SBQueue_Status) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1alpha1api20210601previewstorage.SBQueue_Status)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1alpha1api20210601previewstorage.SBQueue_Status{}
...
func (sbQueueStatus *SBQueue_Status) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1alpha1api20210601previewstorage.SBQueue_Status)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1alpha1api20210601previewstorage.SBQueue_Status{}
...
func (sbQueueStatus *SBQueue_Status) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MaxMessageSizeInKilobytes != nil {
			maxMessageSizeInKilobytes := *typedInput.Properties.MaxMessageSizeInKilobytes
			sbQueueStatus.MaxMessageSizeInKilobytes = &maxMessageSizeInKilobytes
		}
	}
...
func (sbQueueStatus *SBQueue_Status) AssignPropertiesFromSBQueueStatus(source *v1alpha1api20210601previewstorage.SBQueue_Status) error {
	...
	// MaxMessageSizeInKilobytes
	sbQueueStatus.MaxMessageSizeInKilobytes = genruntime.ClonePointerToInt(source.MaxMessageSizeInKilobytes)
...
func (sbQueueStatus *SBQueue_Status) AssignPropertiesToSBQueueStatus(destination *v1alpha1api20210601previewstorage.SBQueue_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if sbQueueStatus.CountDetails != nil {
		var countDetail v1alpha1api20210601previewstorage.MessageCountDetails_Status
	...
	// MaxMessageSizeInKilobytes
	destination.MaxMessageSizeInKilobytes = genruntime.ClonePointerToInt(sbQueueStatus.MaxMessageSizeInKilobytes)
...
func (messageCountDetailsStatus *MessageCountDetails_Status) AssignPropertiesFromMessageCountDetailsStatus(source *v1alpha1api20210601previewstorage.MessageCountDetails_Status) error {
...
func (messageCountDetailsStatus *MessageCountDetails_Status) AssignPropertiesToMessageCountDetailsStatus(destination *v1alpha1api20210601previewstorage.MessageCountDetails_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
