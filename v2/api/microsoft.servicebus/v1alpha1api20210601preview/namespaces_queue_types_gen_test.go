...
// RunPropertyAssignmentTestForNamespacesQueue tests if a specific instance of NamespacesQueue can be assigned to v1alpha1api20210601previewstorage and back losslessly
func RunPropertyAssignmentTestForNamespacesQueue(subject NamespacesQueue) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601previewstorage.NamespacesQueue
...
// RunPropertyAssignmentTestForNamespacesQueuesSpec tests if a specific instance of NamespacesQueues_Spec can be assigned to v1alpha1api20210601previewstorage and back losslessly
func RunPropertyAssignmentTestForNamespacesQueuesSpec(subject NamespacesQueues_Spec) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601previewstorage.NamespacesQueues_Spec
...
// RunPropertyAssignmentTestForSBQueueStatus tests if a specific instance of SBQueue_Status can be assigned to v1alpha1api20210601previewstorage and back losslessly
func RunPropertyAssignmentTestForSBQueueStatus(subject SBQueue_Status) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601previewstorage.SBQueue_Status
...
// RunPropertyAssignmentTestForMessageCountDetailsStatus tests if a specific instance of MessageCountDetails_Status can be assigned to v1alpha1api20210601previewstorage and back losslessly
func RunPropertyAssignmentTestForMessageCountDetailsStatus(subject MessageCountDetails_Status) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601previewstorage.MessageCountDetails_Status
