...
package v1alpha1api20210601preview

import (
	"fmt"
	"github.com/Azure/azure-service-operator/v2/api/microsoft.servicebus/v1alpha1api20210601previewstorage"
...
func (namespace *Namespace) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1alpha1api20210601previewstorage.Namespace
...
func (namespace *Namespace) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1alpha1api20210601previewstorage.Namespace
...
// +kubebuilder:webhook:path=/mutate-microsoft-servicebus-azure-com-v1alpha1api20210601preview-namespace,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.servicebus.azure.com,resources=namespaces,verbs=create;update,versions=v1alpha1api20210601preview,name=default.v1alpha1api20210601preview.namespaces.microsoft.servicebus.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-servicebus-azure-com-v1alpha1api20210601preview-namespace,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.servicebus.azure.com,resources=namespaces,verbs=create;update,versions=v1alpha1api20210601preview,name=validate.v1alpha1api20210601preview.namespaces.microsoft.servicebus.azure.com,admissionReviewVersions=v1beta1
...
func (namespace *Namespace) AssignPropertiesFromNamespace(source *v1alpha1api20210601previewstorage.Namespace) error {
...
func (namespace *Namespace) AssignPropertiesToNamespace(destination *v1alpha1api20210601previewstorage.Namespace) error {

	// Spec
	var spec v1alpha1api20210601previewstorage.Namespaces_Spec
	...
	// Status
	var status v1alpha1api20210601previewstorage.SBNamespace_Status
...
// +kubebuilder:validation:Enum={"2021-06-01-preview"}
type NamespacesSpecAPIVersion string

const NamespacesSpecAPIVersion20210601Preview = NamespacesSpecAPIVersion("2021-06-01-preview")
...
func (namespacesSpec *Namespaces_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1alpha1api20210601previewstorage.Namespaces_Spec)
	if ok {
	...
	src = &v1alpha1api20210601previewstorage.Namespaces_Spec{}
...
func (namespacesSpec *Namespaces_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1alpha1api20210601previewstorage.Namespaces_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1alpha1api20210601previewstorage.Namespaces_Spec{}
...
func (namespacesSpec *Namespaces_Spec) AssignPropertiesFromNamespacesSpec(source *v1alpha1api20210601previewstorage.Namespaces_Spec) error {
...
func (namespacesSpec *Namespaces_Spec) AssignPropertiesToNamespacesSpec(destination *v1alpha1api20210601previewstorage.Namespaces_Spec) error {
	...
	// Encryption
	if namespacesSpec.Encryption != nil {
		var encryption v1alpha1api20210601previewstorage.Encryption
	...
	// Identity
	if namespacesSpec.Identity != nil {
		var identity v1alpha1api20210601previewstorage.Identity
	...
	// Sku
	if namespacesSpec.Sku != nil {
		var sku v1alpha1api20210601previewstorage.SBSku
...
func (sbNamespaceStatus *SBNamespace_Status) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1alpha1api20210601previewstorage.SBNamespace_Status)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1alpha1api20210601previewstorage.SBNamespace_Status{}
...
func (sbNamespaceStatus *SBNamespace_Status) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1alpha1api20210601previewstorage.SBNamespace_Status)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1alpha1api20210601previewstorage.SBNamespace_Status{}
...
func (sbNamespaceStatus *SBNamespace_Status) AssignPropertiesFromSBNamespaceStatus(source *v1alpha1api20210601previewstorage.SBNamespace_Status) error {
...
func (sbNamespaceStatus *SBNamespace_Status) AssignPropertiesToSBNamespaceStatus(destination *v1alpha1api20210601previewstorage.SBNamespace_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if sbNamespaceStatus.DisableLocalAuth != nil {
		disableLocalAuth := *sbNamespaceStatus.DisableLocalAuth
		destination.DisableLocalAuth = &disableLocalAuth
	} else {
		destination.DisableLocalAuth = nil
	}
	...
	if sbNamespaceStatus.Encryption != nil {
		var encryption v1alpha1api20210601previewstorage.Encryption_Status
	...
	if sbNamespaceStatus.Identity != nil {
		var identity v1alpha1api20210601previewstorage.Identity_Status
	...
	if sbNamespaceStatus.PrivateEndpointConnections != nil {
		privateEndpointConnectionList := make([]v1alpha1api20210601previewstorage.PrivateEndpointConnection_Status_SubResourceEmbedded, len(sbNamespaceStatus.PrivateEndpointConnections))
		for privateEndpointConnectionIndex, privateEndpointConnectionItem := range sbNamespaceStatus.PrivateEndpointConnections {
			// Shadow the loop variable to avoid aliasing
			privateEndpointConnectionItem := privateEndpointConnectionItem
			var privateEndpointConnection v1alpha1api20210601previewstorage.PrivateEndpointConnection_Status_SubResourceEmbedded
	...
	if sbNamespaceStatus.Sku != nil {
		var sku v1alpha1api20210601previewstorage.SBSku_Status
	...
	if sbNamespaceStatus.SystemData != nil {
		var systemDatum v1alpha1api20210601previewstorage.SystemData_Status
...
func (encryption *Encryption) AssignPropertiesFromEncryption(source *v1alpha1api20210601previewstorage.Encryption) error {
...
func (encryption *Encryption) AssignPropertiesToEncryption(destination *v1alpha1api20210601previewstorage.Encryption) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if encryption.KeyVaultProperties != nil {
		keyVaultPropertyList := make([]v1alpha1api20210601previewstorage.KeyVaultProperties, len(encryption.KeyVaultProperties))
		for keyVaultPropertyIndex, keyVaultPropertyItem := range encryption.KeyVaultProperties {
			// Shadow the loop variable to avoid aliasing
			keyVaultPropertyItem := keyVaultPropertyItem
			var keyVaultProperty v1alpha1api20210601previewstorage.KeyVaultProperties
...
func (encryptionStatus *Encryption_Status) AssignPropertiesFromEncryptionStatus(source *v1alpha1api20210601previewstorage.Encryption_Status) error {
...
func (encryptionStatus *Encryption_Status) AssignPropertiesToEncryptionStatus(destination *v1alpha1api20210601previewstorage.Encryption_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if encryptionStatus.KeyVaultProperties != nil {
		keyVaultPropertyList := make([]v1alpha1api20210601previewstorage.KeyVaultProperties_Status, len(encryptionStatus.KeyVaultProperties))
		for keyVaultPropertyIndex, keyVaultPropertyItem := range encryptionStatus.KeyVaultProperties {
			// Shadow the loop variable to avoid aliasing
			keyVaultPropertyItem := keyVaultPropertyItem
			var keyVaultProperty v1alpha1api20210601previewstorage.KeyVaultProperties_Status
...
func (identity *Identity) AssignPropertiesFromIdentity(source *v1alpha1api20210601previewstorage.Identity) error {
...
func (identity *Identity) AssignPropertiesToIdentity(destination *v1alpha1api20210601previewstorage.Identity) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (identityStatus *Identity_Status) AssignPropertiesFromIdentityStatus(source *v1alpha1api20210601previewstorage.Identity_Status) error {
...
func (identityStatus *Identity_Status) AssignPropertiesToIdentityStatus(destination *v1alpha1api20210601previewstorage.Identity_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if identityStatus.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]v1alpha1api20210601previewstorage.UserAssignedIdentity_Status, len(identityStatus.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range identityStatus.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityValue := userAssignedIdentityValue
			var userAssignedIdentity v1alpha1api20210601previewstorage.UserAssignedIdentity_Status
...
func (privateEndpointConnectionStatusSubResourceEmbedded *PrivateEndpointConnection_Status_SubResourceEmbedded) AssignPropertiesFromPrivateEndpointConnectionStatusSubResourceEmbedded(source *v1alpha1api20210601previewstorage.PrivateEndpointConnection_Status_SubResourceEmbedded) error {
...
func (privateEndpointConnectionStatusSubResourceEmbedded *PrivateEndpointConnection_Status_SubResourceEmbedded) AssignPropertiesToPrivateEndpointConnectionStatusSubResourceEmbedded(destination *v1alpha1api20210601previewstorage.PrivateEndpointConnection_Status_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (sbSku *SBSku) AssignPropertiesFromSBSku(source *v1alpha1api20210601previewstorage.SBSku) error {
...
func (sbSku *SBSku) AssignPropertiesToSBSku(destination *v1alpha1api20210601previewstorage.SBSku) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (sbSkuStatus *SBSku_Status) AssignPropertiesFromSBSkuStatus(source *v1alpha1api20210601previewstorage.SBSku_Status) error {
...
func (sbSkuStatus *SBSku_Status) AssignPropertiesToSBSkuStatus(destination *v1alpha1api20210601previewstorage.SBSku_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (systemDataStatus *SystemData_Status) AssignPropertiesFromSystemDataStatus(source *v1alpha1api20210601previewstorage.SystemData_Status) error {
...
func (systemDataStatus *SystemData_Status) AssignPropertiesToSystemDataStatus(destination *v1alpha1api20210601previewstorage.SystemData_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (keyVaultProperties *KeyVaultProperties) AssignPropertiesFromKeyVaultProperties(source *v1alpha1api20210601previewstorage.KeyVaultProperties) error {
...
func (keyVaultProperties *KeyVaultProperties) AssignPropertiesToKeyVaultProperties(destination *v1alpha1api20210601previewstorage.KeyVaultProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Identity
	if keyVaultProperties.Identity != nil {
		var identity v1alpha1api20210601previewstorage.UserAssignedIdentityProperties
...
func (keyVaultPropertiesStatus *KeyVaultProperties_Status) AssignPropertiesFromKeyVaultPropertiesStatus(source *v1alpha1api20210601previewstorage.KeyVaultProperties_Status) error {
...
func (keyVaultPropertiesStatus *KeyVaultProperties_Status) AssignPropertiesToKeyVaultPropertiesStatus(destination *v1alpha1api20210601previewstorage.KeyVaultProperties_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Identity
	if keyVaultPropertiesStatus.Identity != nil {
		var identity v1alpha1api20210601previewstorage.UserAssignedIdentityProperties_Status
...
func (userAssignedIdentityStatus *UserAssignedIdentity_Status) AssignPropertiesFromUserAssignedIdentityStatus(source *v1alpha1api20210601previewstorage.UserAssignedIdentity_Status) error {
...
func (userAssignedIdentityStatus *UserAssignedIdentity_Status) AssignPropertiesToUserAssignedIdentityStatus(destination *v1alpha1api20210601previewstorage.UserAssignedIdentity_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (userAssignedIdentityProperties *UserAssignedIdentityProperties) AssignPropertiesFromUserAssignedIdentityProperties(source *v1alpha1api20210601previewstorage.UserAssignedIdentityProperties) error {
...
func (userAssignedIdentityProperties *UserAssignedIdentityProperties) AssignPropertiesToUserAssignedIdentityProperties(destination *v1alpha1api20210601previewstorage.UserAssignedIdentityProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (userAssignedIdentityPropertiesStatus *UserAssignedIdentityProperties_Status) AssignPropertiesFromUserAssignedIdentityPropertiesStatus(source *v1alpha1api20210601previewstorage.UserAssignedIdentityProperties_Status) error {
...
func (userAssignedIdentityPropertiesStatus *UserAssignedIdentityProperties_Status) AssignPropertiesToUserAssignedIdentityPropertiesStatus(destination *v1alpha1api20210601previewstorage.UserAssignedIdentityProperties_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
