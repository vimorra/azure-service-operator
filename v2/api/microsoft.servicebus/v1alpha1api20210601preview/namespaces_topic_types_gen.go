...
func (namespacesTopic *NamespacesTopic) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1alpha1api20210601previewstorage.NamespacesTopic
	...
	err = namespacesTopic.AssignPropertiesFromNamespacesTopic(&source)
	if err != nil {
		return errors.Wrap(err, "converting from source to namespacesTopic")
	}
...
func (namespacesTopic *NamespacesTopic) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1alpha1api20210601previewstorage.NamespacesTopic
	err := namespacesTopic.AssignPropertiesToNamespacesTopic(&destination)
	if err != nil {
		return errors.Wrap(err, "converting to destination from namespacesTopic")
	}
...
// +kubebuilder:webhook:path=/mutate-microsoft-servicebus-azure-com-v1alpha1api20210601preview-namespacestopic,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.servicebus.azure.com,resources=namespacestopics,verbs=create;update,versions=v1alpha1api20210601preview,name=default.v1alpha1api20210601preview.namespacestopics.microsoft.servicebus.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-servicebus-azure-com-v1alpha1api20210601preview-namespacestopic,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.servicebus.azure.com,resources=namespacestopics,verbs=create;update,versions=v1alpha1api20210601preview,name=validate.v1alpha1api20210601preview.namespacestopics.microsoft.servicebus.azure.com,admissionReviewVersions=v1beta1
...
func (namespacesTopic *NamespacesTopic) AssignPropertiesFromNamespacesTopic(source *v1alpha1api20210601previewstorage.NamespacesTopic) error {
...
func (namespacesTopic *NamespacesTopic) AssignPropertiesToNamespacesTopic(destination *v1alpha1api20210601previewstorage.NamespacesTopic) error {

	// Spec
	var spec v1alpha1api20210601previewstorage.NamespacesTopics_Spec
	...
	// Status
	var status v1alpha1api20210601previewstorage.SBTopic_Status
...
const NamespacesTopicsSpecAPIVersion20210601Preview = NamespacesTopicsSpecAPIVersion("2021-06-01-preview")
...
type NamespacesTopics_Spec struct {
	...
	//be accepted by the topic. This property is only used in Premium today and
	//default is 1024.
...
func (namespacesTopicsSpec *NamespacesTopics_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if namespacesTopicsSpec.MaxMessageSizeInKilobytes != nil {
		maxMessageSizeInKilobytes := *namespacesTopicsSpec.MaxMessageSizeInKilobytes
...
func (namespacesTopicsSpec *NamespacesTopics_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties.MaxMessageSizeInKilobytes != nil {
		...
		namespacesTopicsSpec.MaxMessageSizeInKilobytes = &maxMessageSizeInKilobytes
	}
...
func (namespacesTopicsSpec *NamespacesTopics_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1alpha1api20210601previewstorage.NamespacesTopics_Spec)
	if ok {
	...
	src = &v1alpha1api20210601previewstorage.NamespacesTopics_Spec{}
...
func (namespacesTopicsSpec *NamespacesTopics_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1alpha1api20210601previewstorage.NamespacesTopics_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1alpha1api20210601previewstorage.NamespacesTopics_Spec{}
...
func (namespacesTopicsSpec *NamespacesTopics_Spec) AssignPropertiesFromNamespacesTopicsSpec(source *v1alpha1api20210601previewstorage.NamespacesTopics_Spec) error {
	...
	namespacesTopicsSpec.MaxMessageSizeInKilobytes = genruntime.ClonePointerToInt(source.MaxMessageSizeInKilobytes)
...
func (namespacesTopicsSpec *NamespacesTopics_Spec) AssignPropertiesToNamespacesTopicsSpec(destination *v1alpha1api20210601previewstorage.NamespacesTopics_Spec) error {
	...
	// MaxMessageSizeInKilobytes
	destination.MaxMessageSizeInKilobytes = genruntime.ClonePointerToInt(namespacesTopicsSpec.MaxMessageSizeInKilobytes)
...
func (sbTopicStatus *SBTopic_Status) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1alpha1api20210601previewstorage.SBTopic_Status)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1alpha1api20210601previewstorage.SBTopic_Status{}
...
func (sbTopicStatus *SBTopic_Status) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1alpha1api20210601previewstorage.SBTopic_Status)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1alpha1api20210601previewstorage.SBTopic_Status{}
...
func (sbTopicStatus *SBTopic_Status) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MaxMessageSizeInKilobytes != nil {
			maxMessageSizeInKilobytes := *typedInput.Properties.MaxMessageSizeInKilobytes
			sbTopicStatus.MaxMessageSizeInKilobytes = &maxMessageSizeInKilobytes
		}
	}
...
func (sbTopicStatus *SBTopic_Status) AssignPropertiesFromSBTopicStatus(source *v1alpha1api20210601previewstorage.SBTopic_Status) error {
	...
	// MaxMessageSizeInKilobytes
	sbTopicStatus.MaxMessageSizeInKilobytes = genruntime.ClonePointerToInt(source.MaxMessageSizeInKilobytes)
...
func (sbTopicStatus *SBTopic_Status) AssignPropertiesToSBTopicStatus(destination *v1alpha1api20210601previewstorage.SBTopic_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// MaxMessageSizeInKilobytes
	destination.MaxMessageSizeInKilobytes = genruntime.ClonePointerToInt(sbTopicStatus.MaxMessageSizeInKilobytes)
