...
// RunPropertyAssignmentTestForNamespacesTopic tests if a specific instance of NamespacesTopic can be assigned to v1alpha1api20210601previewstorage and back losslessly
func RunPropertyAssignmentTestForNamespacesTopic(subject NamespacesTopic) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601previewstorage.NamespacesTopic
...
// RunPropertyAssignmentTestForNamespacesTopicsSpec tests if a specific instance of NamespacesTopics_Spec can be assigned to v1alpha1api20210601previewstorage and back losslessly
func RunPropertyAssignmentTestForNamespacesTopicsSpec(subject NamespacesTopics_Spec) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601previewstorage.NamespacesTopics_Spec
...
// RunPropertyAssignmentTestForSBTopicStatus tests if a specific instance of SBTopic_Status can be assigned to v1alpha1api20210601previewstorage and back losslessly
func RunPropertyAssignmentTestForSBTopicStatus(subject SBTopic_Status) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601previewstorage.SBTopic_Status
