...
func (sqlDatabaseContainerThroughputSetting *SqlDatabaseContainerThroughputSetting) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v1alpha1api20210515storage.SqlDatabaseContainerThroughputSetting)
	if !ok {
		return fmt.Errorf("expected storage:microsoft.documentdb/v1alpha1api20210515storage/SqlDatabaseContainerThroughputSetting but received %T instead", hub)
	}

	return sqlDatabaseContainerThroughputSetting.AssignPropertiesFromSqlDatabaseContainerThroughputSetting(source)
}
...
func (sqlDatabaseContainerThroughputSetting *SqlDatabaseContainerThroughputSetting) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v1alpha1api20210515storage.SqlDatabaseContainerThroughputSetting)
	if !ok {
		return fmt.Errorf("expected storage:microsoft.documentdb/v1alpha1api20210515storage/SqlDatabaseContainerThroughputSetting but received %T instead", hub)
	}

	return sqlDatabaseContainerThroughputSetting.AssignPropertiesToSqlDatabaseContainerThroughputSetting(destination)
}
